    ...
    local function updateDoubleWeights()
    doubleWeights = {}
    for i, v in pairs(player.Character:GetChildren()) do
        if v:IsA("Tool") and v.Name == "Double Weight" then
            table.insert(doubleWeights, v)
        end
    end
end
    ...
    if getgenv().farmer == true then
        for _, weight in ipairs(doubleWeights) do
            if weight:IsDescendantOf(player.Character) then
                weight:Activate()
            end
        end
    end
	...
	local Section = Tab:NewSection("Dupe Your Weights")

	Section:NewButton("Auto Dupe V1 (Less than 80k Size (80 Weights))", "Gives Weights Then Farms", function()
...
Section:NewButton("Auto Dupe V2 (More Than 80k Size (830 Weights))", "Gives Weights Then Farms", function()
	...
	Section:NewButton("Click Here!", "Click Button", function()
		-- Gui to Lua
		-- Version: 3.2
		...
		local function MMLV_fake_script() -- SE.LocalScript 
			...
			str:GetPropertyChangedSignal("Value"):Connect(function()
				...
				earned += delta;
				SE.Text = "Earned: "..Format(earned,2);
				curvalue = str.Value;
			end)
		end
	...
	local Section = Tab:NewSection("LxstSou1zz")
