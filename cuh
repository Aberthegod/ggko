	...
	Section:NewSlider("Drag To Any Amount", "Dupe What Ever You Drag To", 1000, 1, function(s) -- 500 (MaxValue) | 0 (MinValue)
		num1 = tonumber(s)
	end)


Section:NewTextBox("Enter Any Amount", "Set How Much You Dupe", function(txt)
    num1 = tonumber(txt)
end)

Section:NewButton("Click To Dupe Weights", "Gives Weights Then Farms", function()
